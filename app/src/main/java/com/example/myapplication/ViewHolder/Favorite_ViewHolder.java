...
public class Favorite_ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView titeltext,posttext;
    public ImageView images,imageFanorit;

    com.example.myapplication.InterFace.itemOnClickListener itemOnClickListener;

    public Favorite_ViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        imageFanorit= (ImageView) itemView.findViewById(R.id.imagefone_contextfrind);
